...
1. Problem #1 [Easy]: Given a list of numbers and a number k, return whether any two numbers from the list add up to k. 
	...
	* Bonus: Can you do this in one pass?
	...
	a. Solution (Java) [VerifyIfTwoNumbersInAListAddUpToK.java](https://github.com/ramonfigueiredopessoa/java_programming/blob/master/solutions_for_coding_problems/VerifyIfTwoNumbersInAListAddUpToK.java)
...
2. Problem #2 [Hard]: Given an array of integers, return a new array such that each element at index i of the new array is the product of all the numbers in the original array except the one at i.
	...
	* Follow-up: what if you can't use division?
	...
	a. Solution (Python) [ArrayWithTheProductOfAll.java](https://github.com/ramonfigueiredopessoa/java_programming/blob/master/solutions_for_coding_problems/ArrayWithTheProductOfAll.java)
